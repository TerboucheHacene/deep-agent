...
def format_message_content(message: AnyMessage) -> str:
...
def format_messages(messages: list[AnyMessage]) -> None:
...
def format_message(messages: list[AnyMessage]) -> None:
    """Alias for format_messages for backward compatibility."""
    return format_messages(messages)


def show_prompt(
    prompt_text: str, title: str = "Prompt", border_style: str = "blue"
) -> None:
...
async def stream_agent(
    agent: Runnable, query: Any, config: RunnableConfig = None
) -> Any:
